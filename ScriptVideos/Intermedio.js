...
// Definir una lista de fuentes de video para el reproductor de video
const videoSources = [
  'VideosEjercicios/IntermedioParte1.mp4',
  'VideosEjercicios/IntermedioParte2.mp4',
  'VideosEjercicios/IntermedioParte3.mp4'
];
